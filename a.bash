      ...
      comments_url="https://api.github.com/repos/ramneekkh/k8s-cost-estimator-github/issues/$_PR_NUMBER/comments"
      ...
      if (( $(echo "$$POSSIBLY_COST_INCREASE > $$COST_USD_THRESHOLD" | bc -l) ))
        then
          ...
          echo "****************************************************************************************"   
          reviewers_url="https://api.github.com/repos/ramneekkh/k8s-cost-estimator-github/pulls/$_PR_NUMBER/requested_reviewers"
